...
/**
 * Live_Rating class. This class should ideally be used to work with the
 * public-facing side of the WordPress site.
 *
 * If you're interested in introducing administrative or dashboard
 * functionality, then refer to `class-live-rating-admin.php`
 *
 * @package Live_Rating
 * @author  Stefan Ghiata <stefan.ghiata@gmail.com>
 */
class Live_Rating {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'live-rating';
	...
	private function __construct() {
		 ...
		 */
		add_action( 'wp_head', array( $this, 'action_add_token' ) );
